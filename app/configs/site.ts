...
export const skills = [
  {
    ...
    years: 5,
    logo: imgReact.src,
    className: 'border-[#61DAFB] bg-[#61DAFB]',
  },
  {
    name: 'Next.js',
    group: 'JavaScript',
    years: 5,
    logo: imgNext.src,
    className: 'border-[#000000] bg-[#000000]',
  },
  {
    name: 'Vue.js',
    group: 'JavaScript',
    years: 7,
    logo: imgVue.src,
    className: 'border-[#4FC08D] bg-[#4FC08D]',
  },
  {
    name: 'Nuxt.js',
    group: 'JavaScript',
    years: 7,
    logo: imgNuxt.src,
    className: 'border-[#00DC82] bg-[#00DC82]',
  },
  {
    name: 'Tailwind',
    group: 'Styling',
    ...
    className: 'border-[#06B6D4] bg-[#06B6D4]',
  },
  {
    name: 'Laravel',
    group: 'Backend',
    years: 7,
    logo: imgLaravel.src,
    className: 'border-[#FF2D20] bg-[#FF2D20]',
  },
  {
    name: 'Flask',
    group: 'Backend',
  ...
  },
  {
    ...
    years: 1,
    logo: imgStrapi.src,
    className: 'border-[#8C4BFF] bg-[#8C4BFF] !p-2.5',
  },
]
